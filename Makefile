...
CXX_FLAGS += -Idll/etl/include -Idll/etl/lib/include -Idll/include
...
# Performances
CXX_FLAGS += -DETL_MKL -DETL_VECTORIZE_FULL $(shell pkg-config --cflags mkl-threads)

$(eval $(call auto_folder_compile,src))
$(eval $(call auto_add_executable,caltech))

release: release_caltech
release_debug: release_debug_caltech
debug: debug_caltech
